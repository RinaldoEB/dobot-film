            ...
            <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-xl text-gray-300 mb-8">
                        Have questions, feedback, or found a bug? Reach out to us on GitHub!
                    </p>
                </div>
                ...
                <div className="bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-2xl font-semibold mb-4">Connect with us on GitHub</h3>
                        <p className="text-gray-300 mb-6 max-w-md">
                            Report issues, suggest features, or contribute to the Dobot Film project. We're always open to collaboration and feedback from the community.
                        </p>
                        <a
                            href="https://github.com/RinaldoEB"
                            target="_blank"
                ...
                <div className="mt-12 text-gray-400">
                    <p>Thank you for your interest in Dobot Film! We appreciate your support and contributions.</p>
                </div>
            </div>
        </div>
    )
